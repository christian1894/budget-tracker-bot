...
class TransactionCategoriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create transaction_category" do
    assert_difference("TransactionCategory.count") do
      post transaction_categories_url, params: { transaction_category: { name: @transaction_category.name } }
    end
  ...
  test "should update transaction_category" do
    patch transaction_category_url(@transaction_category), params: { transaction_category: { name: @transaction_category.name } }
